      ...
      <div id="wrapper" class="wrapper-fluid banners-effect-5">
         ...
         <div class="main-container container">
            <ul class="breadcrumb">
               ...
               <li><a href="{{ url('productList') }}">Product</a></li>
               <li><a href="#">@if(isset($productData)) {{$productData->product_name}} @endif</a></li>
            </ul>
            <div class="row">
               <!--Middle Part Start-->
               <div id="content" class="col-md-12 col-sm-12">
                  <div class="article-info">
                     <div class="blog-header">
                        <h3>@if(isset($productData)) {{$productData->product_name}} @endif</h3>
                     </div>
                     <div class="form-group">
                        ...
                        @if($productData->product_image!="")
                           <a href="{{ url('product/'.$productData->product_image) }}" class="image-popup">
                              <img src="{{ url('product/'.$productData->product_image) }}" alt="{{$productData->product_name}}" class="productImage">
                           </a>
                        @else
