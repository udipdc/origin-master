...
<head>
    ...
    <link href="{{asset('front/js/slick-slider/slick.css')}}" rel="stylesheet">
    ...
    <link href="{{asset('front/css/themecss/so-deals.css')}}" rel="stylesheet">
    ...
    <link id="color_scheme" href="{{asset('front/css/home3.css')}}" rel="stylesheet">
                       ...
                       <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                          <div class="logo">
                            ...
                            @if(isset(settingData()->site_logo) && !empty(settingData()->site_logo))
                                <a href="{{ url('/') }}"><img src="{{asset('front/images/Logo/'.settingData()->site_logo)}}" alt="brand-logo" ></a>
                            @else
                                <a href="{{ url('/') }}"><img src="{{asset('front/images/Logo/MedicalLogo.jpg')}}" alt="" ></a>
                            @endif
                                            ...
                                            <div class="container-mega">
                                               <ul class="megamenu menuText" data-transition="slide" data-animationtime="250">
                                                  <li class="">
                                                     ...
                                                     <strong style="text-transform:capitalize;">{{ ucfirst('Home') }}</strong>
                                                     </a>
                                                  </li>
