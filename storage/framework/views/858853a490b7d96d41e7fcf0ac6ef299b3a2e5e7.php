            ...
            <div class="col-12">
                  ...
                  <div class="card-body">
                        <div class="table-responsive">
                            <table id="productTable" class="table table-striped table-bordered zero-configuration">
                                <thead>
                                    <tr>
                                      <th>Name</th>
                                      <th>Status</th>
        ...
        closeOnConfirm: !1
             ...
             $.ajax({
               ...
               success:function(data) {
                ...
                swal("Deleted !!", "Hey, Product has been deleted !!", "success")
               }
            });
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\MedicalStore\resources\views/admin/product/index.blade.php ENDPATH**/ ?>